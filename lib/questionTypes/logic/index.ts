...
import { tapTargetLogic } from './taptarget';
...
export { tapTargetLogic, tapDistance } from './taptarget';
export type { TapTargetSubmission } from './taptarget';
