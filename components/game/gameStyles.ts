...
export const gameStyles = StyleSheet.create({
  ...
  swipeStage: { height: 240, width: '100%', alignItems: 'center', justifyContent: 'center' },
  swipeCard: {
    position: 'absolute', width: 260, height: 190, borderRadius: 22, backgroundColor: Colors.surface,
    alignItems: 'center', justifyContent: 'center', padding: 22, ...CardShadow,
  },
  swipeCardBehind: { transform: [{ scale: 0.92 }, { translateY: 14 }], opacity: 0.55 },
  swipeCardText: { fontSize: 20, fontWeight: '700', color: Colors.textPrimary, textAlign: 'center' },
  swipeHintBadge: {
    position: 'absolute', top: 24, paddingVertical: 6, paddingHorizontal: 14, borderRadius: 12, borderWidth: 3,
  },
  swipeHintLeft: { left: 8, borderColor: Colors.primary, transform: [{ rotate: '-12deg' }] },
  swipeHintRight: { right: 8, borderColor: Colors.danger, transform: [{ rotate: '12deg' }] },
  swipeHintText: { fontWeight: '900', fontSize: 13, color: Colors.textPrimary },
  swipeBtnRow: { flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginTop: 8, gap: 12 },
  swipeBtn: {
    flex: 1, textAlign: 'center', color: Colors.white, fontWeight: '800', fontSize: 14, overflow: 'hidden',
  ...
  estimateReadout: { fontSize: 40, fontWeight: '900', color: Colors.accent, textAlign: 'center' },
  estimateUnit: { fontSize: 16, color: Colors.textSecondary, fontWeight: '700', textAlign: 'center' },
  estimateRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 16, width: '100%' },
  estimateReadoutWrap: { alignItems: 'center', minWidth: 140 },
  estimateStepBtn: {
    width: 52, height: 52, borderRadius: 26, backgroundColor: Colors.surface,
    alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: Colors.accentDim, ...CardShadow,
  },
  estimateStepText: { fontSize: 28, fontWeight: '900', color: Colors.accent, marginTop: -2 },
  numberLine: {
